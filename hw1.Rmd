...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer:
    My name is **Ibrahim Murat Oztok** and I am an *economics* major. I like working out, watching movies and going out with friends. I am interested in data science because I believe the field has great potential in the future and it will help us to solve our most challenging problems that we face today.
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer:   Machine learning engineer is a job that I think is related to data science. ML engineers analyze, manipulate and organize data to make logical conclusions.
  
    <https://www.expert.ai/blog/machine-learning-definition/>         [link](https://www.expert.ai/blog/machine-learning-definition/)
      
  ![](pg_mlnxtdcd_072616.png)


5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer:   I am most interested in Artificial Intelligence part of data science.
...
9. Configure your git username and user email by modifying and entering the following commands into the terminal
    ...
    ```
    git config --global user.name "muratoztok"
    git config --global user.email "imoztok@iastate.edu"
    ```
